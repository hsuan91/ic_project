...
module bootloader (
	...
	localparam INST_MEM_CAPACITY   = 'h400;
    ...
    always_ff @(posedge clk) begin
        ...
        else if (sram_addr == 'h3ff && end_32bit == 'b1 && config_flag) begin
    ...
    // Data shift register
    always_ff @(posedge clk) begin
        data_temp <= {data_temp[30:0], flash_so};
    end
